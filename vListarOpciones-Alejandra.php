			...
			for ($i=0; $i<sizeof($_SESSION[cod_proyecto]);$i++){
				...
				if (in_array($_SESSION[cod_proyecto][$i], $_SESSION[cod_proyecto_culminado])){
					...
					if ($_SESSION[proy_aprobado][$i]=="SI"){
						echo "<a href='vNotificarCulminacion.php?id=".$_SESSION[id_inscripcion][$i]."'>".mostrarImagen('notificar')."";
					}
					...
					if ($_SESSION[proy_aprobado][$i]==" "){
						echo "<br></br>"
						?>
							<div id="message<?php echo 2;?>"><?php echo $messages_alerta[1]; ?></div>
							<div id="message<?php echo 4;?>"><?php echo $messages_alerta[0]; ?></div>
						<?php 
					}
					if ($_SESSION[proy_aprobado][$i]=="SI"){
						...
						if ($dias_restantes){
							?>
								<div id="message<?php echo 4;?>"><?php echo $messages_alerta[2]." Quedan ".$dias_restantes." d&iacute;a(s)"; ?></div>
							<?php
						}
					}
				}
	...
	//		} //cierra el if inscrito
			...
			<?php
				if (isset($_SESSION['inscrito']) and !$_SESSION['inscrito'] and $_SESSION[horas]<120) {
					?>
						<?php if  (periodoInscripcion($conexion)){ ?>
				...
				if  (periodoFormulacion($conexion)){ ?>
                    <li class="parrafo"><a href="vAgregarProyecto.php">Formular un proyecto nuevo</a></li><?php 
				} ?>    
                    <li class="parrafo"><a href="vActualizarDatosEstudiante.php">Actualizar Perfil</a></li><?php
			...
			if (isAdmin()){		
				...
				if(isset($messages_error)):
					foreach($messages_error as $messg): ?>
						<div id="message<?php echo $index+1;?>"><?php echo $messages_error[$index]; ?></div>
						<?php $index++; 
					endforeach; 
				endif;
				$index2=0;
				if(isset($messages)): 
					foreach($messages as $messg): ?>
						<div id="message<?php echo $index+1;?>"><?php echo $messages[$index2]; ?></div>
						<?php $index++; $index2++; 
					endforeach;
				endif;?>
				...
				<li class="parrafo">
					...
					<ul>
						...
						if ($_SESSION[sede]=='Sartenejas'){ ?>
							<li class="parrafo"><a href="vListarProyectos.php?opcion=por evaluar">Evaluar Proyectos </a></li><?php
						} ?>
						<li class="parrafo"><a href="vListarInscripciones.php">Evaluar Inscripciones</a> </li>						
						<li class="parrafo"><a href="vListarInscripciones.php?opcion=validar_culminacion">Certificar culminaci&oacute;n de servicio</a></li>
				...
				<li class="parrafo">
					...
					<ul><?php 
						if ($_SESSION[sede]=='Sartenejas'){ ?>
							...
							<li class="parrafo"><a href="vEspecificarRoles.php">Especificar Roles</a></li><?php 
						}?>
			...
			<li class="parrafo">
				...
				<ul>
					...
					<li class="parrafo"><a href="vListarProyectos.php">Ver lista de proyectos aprobados</a></li>
							<?php if  (periodoFormulacion($conexion)){ ?>
					<li class="parrafo"><a href="vAgregarProyecto2.php">Formular un proyecto nuevo</a></li>
							<?php } ?>
				</ul>
			</li><?php
