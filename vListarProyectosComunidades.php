...
<title>Proyectos Propuestos por Areas y Comunidades - SERVICIO COMUNITARIO</title>
...
<div align="right"><span class="parrafo">
  ...
  <td valign="top" class="parrafo" align="center">
	...
	PROYECTOS DE SERVICIO COMUNITARIO PROPUESTOS<br />(&Aacute;reas Vs. Comunidades)</span>
<br /><br />
...
<form id="rango_fechas" name="rango_fechas" method="post" action="vListarProyectosComunidades.php">    
...
<? if (isset($_POST[aceptar])) {
	echo "<br /> <center>";
	$titulo = "SSC_Proyectos_Areas_Comunidades.pdf";
?>
...
<?	
	...
	include "cListarProyectosComunidades.php";
?>
