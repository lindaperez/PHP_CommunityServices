...
<div align="right"><span class="parrafo">
  ...
  <td valign="top" class="parrafo" align="center">
	...
	ESTUDIANTES APROBADOS EN PROYECTOS DE SERVICIO COMUNITARIO<br />(&Aacute;reas Vs. Carreras)</span>
<br /><br />
...
<form id="rango_fechas" name="rango_fechas" method="post" action="vListarEstAprobadosAC.php">    
...
<? if (isset($_POST[aceptar])) {
	echo "<br /> <center>";
	$titulo = "SSC_Aprobados_Carreras_Areas.pdf";
?>
...
<?
	...
	include "cListarEstAprobadosAC.php";
?>
