...
<title>Listar Estudiantes por &Aacute;reas y Carreras - SERVICIO COMUNITARIO</title>
...
<div align="right"><span class="parrafo">
  ...
  <td valign="top" class="parrafo" align="center">
	...
	ESTUDIANTES INSCRITOS EN PROYECTOS DE SERVICIO COMUNITARIO<br />(&Aacute;reas Vs. Carreras)</span>
<br /><br />
...
<form id="rango_fechas" name="rango_fechas" method="post" action="vListarEstAreaCarreras.php">    
...
<? if (isset($_POST[aceptar])) {
	echo "<br /> <center>";
	$titulo = "SSC_Inscritos_Carreras_Areas.pdf";
?>
...
<?
	...
	include "cListarEstAreaCarreras.php";
?>
