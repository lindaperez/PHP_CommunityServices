...
<title>Listar Estudiantes por Carreras y Cohortes - SERVICIO COMUNITARIO</title>
...
<div align="right"><span class="parrafo">
  ...
  <td valign="top" class="parrafo" align="center">
	...
	ESTUDIANTES INSCRITOS EN PROYECTOS DE SERVICIO COMUNITARIO<br />(Carreras Vs. Cohortes)</span>
<br /><br />
...
<form id="rango_fechas" name="rango_fechas" method="post" action="vListarEstCarreraCohortes.php">    
...
<? if (isset($_POST[aceptar])) {
	echo "<br /> <center>";
	$titulo = "SSC_Inscritos_Carreras_Cohortes.pdf";
?>
...
<?	
	...
	include "cListarEstCarreraCohortes.php";
?>
