...
$modo_depuracion=false;
        ...
        $sql_select ="SELECT py.*, u.nombre, u.apellido, u.usbid, a.nombre area ";
	$sql_from ="FROM proyecto py, proponente p, usuario u, area_proyecto a ";
	$sql_where="WHERE py.id=p.id_proyecto AND p.usbid_usuario=u.usbid AND py.id_area_proy=a.id ";
