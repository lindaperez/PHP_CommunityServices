...
<title>Listar Estudiantes Aprobados por Carreras y Cohortes - SERVICIO COMUNITARIO</title>
...
<div align="right"><span class="parrafo">
  ...
  <td valign="top" class="parrafo" align="center">
	...
	ESTUDIANTES APROBADOS EN PROYECTOS DE SERVICIO COMUNITARIO<br />(Carreras Vs. Cohortes)</span>
<br /><br />
...
<form id="rango_fechas" name="rango_fechas" method="post" action="vListarEstAprobadosCC.php">    
...
<? if (isset($_POST[aceptar])) {
	echo "<br /> <center>";
	$titulo = "SSC_Aprobados_Carreras_Cohortes.pdf";
?>
...
<?
	...
	include "cListarEstAprobadosCC.php";
?>
