...
$hasta = $_SESSION[hasta];
	...
	$html .= "<tr><td align=\"center\"><br><br><h2>ESTUDIANTES INSCRITOS EN PROYECTOS DE SERVICIO COMUNITARIO (Carreras Vs. Cohortes)</h2><br>";
	...
	<?
	for($y=0;$y<$i;$y++){
		echo "<tr align=left><td><b>$nombres_carreras[$y]</b></td>";
