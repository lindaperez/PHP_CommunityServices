...
$hasta = $_SESSION[hasta];
	...
	$html .= "<tr><td align=\"center\"><br><br><h2>ESTUDIANTES INSCRITOS EN PROYECTOS DE SERVICIO COMUNITARIO (Carreras Vs. Areas)</h2><br>";
	...
	<tr>
    	<td width=200 style="color:#06F; font-size:12px" align="center"><b>&Aacute;reas Vs. Carreras</b></td>
	<?
	...
	for($y=0;$y<$i;$y++){
		...
		for($x=0;$x<$j;$x++){
			$sql3="SELECT COUNT(DISTINCT I.usbid_estudiante) AS nro_est
			   ...
			   AND fecha_inscip BETWEEN '$desde' AND '$hasta' 
