...
<table class="editar_proyecto">
	...
	<tr>
		...
		<td class="left">
			<textarea name="title" id="title"><?php if (isset($_POST['title'])) echo $_POST['title']; else echo $PROYECTO['titulo']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="impacto_social" id="title"><?php if (isset($_POST['impacto_social'])) echo $_POST['impacto_social']; else echo $PROYECTO['impacto_social']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
	...
	<tr>
		...
		<td class="left">
			<textarea name="resumen" id="title"><?php if (isset($_POST['resumen'])) echo $_POST['resumen']; else echo $PROYECTO['resumen']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="area_de_trabajo" id="title"><?php if (isset($_POST['area_de_trabajo'])) echo $_POST['area_de_trabajo']; else echo $PROYECTO['area_de_trabajo']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="antecedentes" id="title"><?php if (isset($_POST['antecedentes'])) echo $_POST['antecedentes']; else echo $PROYECTO['antecedentes']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right"><span class="required">*</span>Objetivo General:</td>
		<td class="left">
			<textarea name="obj_general" id="title"><?php if (isset($_POST['obj_general'])) echo $_POST['obj_general']; else echo $PROYECTO['obj_general']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right"><span class="required">*</span>Objetivos Espef&iacute;ficos:</td>
		<td class="left">
			<textarea name="obj_especificos" id="title"><?php if (isset($_POST['obj_especificos'])) echo $_POST['obj_especificos']; else echo $PROYECTO['obj_especificos']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right"><span class="required">*</span>Descripcion:</td>
		<td class="left">
			<textarea name="descripcion" id="title"><?php if (isset($_POST['descripcion'])) echo $_POST['descripcion']; else echo $PROYECTO['descripcion']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="actividades" id="title"><?php if (isset($_POST['actividades'])) echo $_POST['actividades']; else echo $PROYECTO['actividades']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="perfil" id="title"><?php if (isset($_POST['perfil'])) echo $_POST['perfil']; else echo $PROYECTO['perfil']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="recursos" id="title"><?php if (isset($_POST['recursos'])) echo $_POST['recursos']; else echo $PROYECTO['recursos']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="logros" id="title"><?php if (isset($_POST['logros'])) echo $_POST['logros']; else echo $PROYECTO['logros']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="directrices" id="title"><?php if (isset($_POST['directrices'])) echo $_POST['directrices']; else echo $PROYECTO['directrices']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="magnitud" id="title"><?php if (isset($_POST['magnitud'])) echo $_POST['magnitud']; else echo $PROYECTO['magnitud']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
		...
		<td class="left">
			<textarea name="participacion" id="title"><?php if (isset($_POST['participacion'])) echo $_POST['participacion']; else echo $PROYECTO['participacion']; ?></textarea>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="left">
			<textarea name="formacion_desc" id="title"><?php if (isset($_POST['formacion_desc'])) echo $_POST['formacion_desc']; else echo $PROYECTO['formacion_desc']; ?></textarea>
		</td>
	</tr>
	<tr>
		<td class="right">
