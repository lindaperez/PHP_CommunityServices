...
<form name="datos" action="cAgregarProyecto.php" method="post" enctype="multipart/form-data">
    ...
    <td colspan="4" valign="top" class="parrafo">
        ...
        <table>
            ...
            <tr>
				...
				<!--
				<tr>
					<td colspan="4" valign="top" class="parrafo"><?// include "vBottom.php"; ?></td>
				</tr>
					-->
				</table>
			</td>
