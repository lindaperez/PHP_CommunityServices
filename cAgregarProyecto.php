...
function guardar_comunidad(){    
    ...
    if ($_POST[comuni_id]<>""){
        ...
        if (!empty($_POST[comuni_nombre])){
            ...
            "0, ".//id
            "trim('".replace_form($_POST[comuni_nombre])."'), ".//nombre
            "trim('".replace_form($_POST[comuni_ubic])."'), ".//ubicacion
            "trim('".replace_form($_POST[comuni_desc])."') ".//descripcion		
            ")";
...
function guardar_representante(){    
    ...
    if ($_POST[rep_id]<>""){
        ...
        if (!empty($_POST[rep_email])){
            ...
            $sql_hey="SELECT id FROM representante WHERE email LIKE '%".replace_form($_POST[rep_email])."%'";
            ...
            if ((numResultados($resultado)>0)){
                ...
                $_WARNING[] = 'El representante "'.replace_form($_POST[rep_nombres]). " ".replace_form($_POST[rep_apellidos]).'" ya se encontraba registrado
                            con el correo "'.replace_form($_POST[rep_email]).'@usb.ve" <br/> De todas formas, su Proyecto se ha
...
function guardar_organizacion(){    
    ...
    if ($_POST[org_nombre]==""){
        ...
        if (!empty($_POST[org_nombre])){
            ...
            "0, ".//id
            "trim('".replace_form($_POST[org_nombre])."'), ".//nombre
            "trim('".replace_form($_POST[org_dir])."'), ".//direccion
            "trim('".replace_form($_POST[org_email])."'), ".//email
            "trim('".replace_form($_POST[org_tlf])."'), ".//tlf
            "trim('".replace_form($_POST[org_fax])."') ".//tlf
            ")";
            if ($modo_depuracion) echo "$sql_temp<br>";
            $resultado=ejecutarConsulta($sql_temp, $conexion);
...
function guardar_organizacion_viejo($aux_id_organizacion){    
    ...
    if ($_POST[org_nombre]==""){
        ...
        if (!empty($_POST[org_nombre])){
            ...
            "nombre=trim('".replace_form($_POST[org_nombre])."'), ".//nombre
            "direccion=trim('".replace_form($_POST[org_dir])."'), ".//direccion
            "email=trim('".replace_form($_POST[org_email])."'), ".//email
            "telefono=trim('".replace_form($_POST[org_tlf])."'), ".//tlf
            "fax=trim('".replace_form($_POST[org_fax])."') ".//tlf
...
function guardar_proyecto_nuevo($id_comunidad,$id_rep,$id_org,$status){    
    ...
    "0, ".//id
    "'".replace_form($_SESSION[USBID])."', ".//usbid_postula
    "'$status', ".//status del proyecto
    "'', ".//codigo
    "now() , ".//fecha ingreso
    "trim('$id_comunidad'), ".// id comunidad
    "trim('".replace_form($_POST[titulo])."'), ".
    "trim('".replace_form($_POST[area_proy])."'), ".//id area proy
    "trim('".replace_form($_POST[impacto])."'), ".
    "trim('".replace_form($_POST[resumen])."'), ".
    "trim('".replace_form($_POST[area_trabajo])."'), ".
    "trim('".replace_form($id_rep)."'),". //id representante
    "trim('".replace_form($id_org)."'),". //id organizacion
    "trim('".replace_form($_POST[antecedentes])."'), ".
    "trim('".replace_form($_POST[obj_gral])."'), ".
    "trim('".replace_form($_POST[obj_esp])."'), ".
    "trim('".replace_form($_POST[desc])."'), ".
    "trim('".replace_form($_POST[act_esp])."'), ".
    "trim('".replace_form($_POST[perfil])."'), ".
    "trim('".replace_form($_POST[recursos])."'), ".
    "trim('".replace_form($_POST[logros])."'), ".
    "trim('".replace_form($_POST[directrices])."'), ".
    "trim('".replace_form($_POST[magnitud])."'), ".
    "trim('".replace_form($_POST[participacion])."'), ".
    "trim('".replace_form($_POST[formacion_req])."'), ".
    "trim('".replace_form($_POST[formacion_esp])."'), ".
    "trim('".replace_form($_POST[horas])."'), ".
    "'',".//firmado
    "'NO',".//aprobado
    "'',".//fecha firma
    "'',".//fecha aprob
...
function guardar_proyecto_viejo($id_proy,$id_comunidad,$id_rep,$id_org,$status){    
    ...
    "titulo=trim('".replace_form($_POST[titulo])."'), ".
    "id_area_proy=trim('".replace_form($_POST[area_proy])."'), ".//id area proy
    "impacto_social=trim('".replace_form($_POST[impacto])."'), ".
    "resumen=trim('".replace_form($_POST[resumen])."'), ".
    "area_de_trabajo=trim('".replace_form($_POST[area_trabajo])."'), ".
    "id_representante=trim('".replace_form($id_rep)."'),". //id representante
    "id_organizacion=trim('".replace_form($id_org)."'),". //id organizacion
    "antecedentes=trim('".replace_form($_POST[antecedentes])."'), ".
    "obj_general=trim('".replace_form($_POST[obj_gral])."'), ".
    "obj_especificos=trim('".replace_form($_POST[obj_esp])."'), ".
    "descripcion=trim('".replace_form($_POST[desc])."'), ".
    "actividades=trim('".replace_form($_POST[act_esp])."'), ".
    "perfil=trim('".replace_form($_POST[perfil])."'), ".
    "recursos=trim('".replace_form($_POST[recursos])."'), ".
    "logros=trim('".replace_form($_POST[logros])."'), ".
    "directrices=trim('".replace_form($_POST[directrices])."'), ".
    "magnitud=trim('".replace_form($_POST[magnitud])."'), ".
    "participacion=trim('".replace_form($_POST[participacion])."'), ".
    "formacion=trim('".replace_form($_POST[formacion_req])."'), ".
    "formacion_desc=trim('".replace_form($_POST[formacion_esp])."'), ".
    "horas=trim('".replace_form($_POST[horas])."') ".
    "WHERE id='$id_proy'";
    ...
    "sexo_fem=trim('".replace_form($_POST[cant_fem])."'), ".//cantidad de mujeres
    "sexo_masc=trim('".replace_form($_POST[cant_masc])."'), ".//cantidad de hombres
    "edad_min=trim('".replace_form($_POST[min_edad])."'), ".//edad minima
    "edad_max=trim('".replace_form($_POST[max_edad])."'), ".//edad maxima
    "discapacidad=trim('".replace_form($_POST[cant_disc])."') ".//cantidad de discapacitados
...
function guardar_proponente($id_proy){
    ...
    if ($_POST[prop_usbid]<>""){
            ...
            $sql_temp.="'".replace_form($_POST[prop_usbid])."','$id_proy')";
            if ($modo_depuracion) echo "$sql_temp<br>";
            $resultado=ejecutarConsulta($sql_temp, $conexion);			
        ...
        //Se Verifica que el proponente nuevo no se encuentre en la tabla de proponente
            if (!existe_en_bd(replace_form($_POST[prop_usbid_nuevo]),'proponente','usbid_usuario')){



                    //Aqui se debe colocar el codigo nuevo para verificar
                    $sql_temp="INSERT INTO proponente VALUES (";
                    $sql_temp.="'".replace_form($_POST[prop_usbid_nuevo])."','$id_proy')";
                    if ($modo_depuracion) echo "$sql_temp<br>";
                    $resultado=ejecutarConsulta($sql_temp, $conexion);			            

                    global $_WARNING;
                    $_WARNING[] = 'El proponente "'.replace_form($_POST[prop_nombre]). " ".replace_form($_POST[prop_apellido]).'" ya se encontraba registrado
                        con el correo "'.replace_form($_POST[prop_usbid_nuevo]).'@usb.ve" <br/> De todas formas, su Proyecto se ha 
                        agregado satisfactoriamente.';

                } else {
                        //Se Verifica que el proponente nuevo no se encuentre en la tabla de usuario
                        if (!existe_en_bd(replace_form($_POST[prop_usbid_nuevo]),'usuario','usbid')){
                            $sql_temp="INSERT INTO usuario (usbid, nombre, apellido, password, ci) VALUES (".
                            "trim('".replace_form($_POST[prop_usbid_nuevo])."'), ".//usbid
                            "trim('".replace_form($_POST[prop_nombre])."'), ".//nombre
                            "trim('".replace_form($_POST[prop_apellido])."'), ".//apellido
                            "'1234', ".//password. Esto es temporal dado que se va a utilizar el usbid verdadero para el acceso prop_ci
                            "trim('".replace_form($_POST[prop_ci])."'))"; //cedula
                            $resultado=ejecutarConsulta($sql_temp, $conexion);
                            if ($modo_depuracion) echo "$sql_temp<br>";
                        }
                        //Se Verifica que el proponente nuevo no se encuentre en la tabla de usuario_estudiante
                        if (!existe_en_bd(replace_form($_POST[prop_usbid_nuevo]),'usuario_estudiante','usbid_usuario')){
                            if ($_POST[prop_carnet]<>""){
                                    $sql_temp="INSERT INTO usuario_estudiante (usbid_usuario, carnet) VALUES (";
                                    $sql_temp.="'".replace_form($_POST[prop_usbid_nuevo])."','".replace_form($_POST[prop_carnet])."')";
                                    if ($modo_depuracion) echo "$sql_temp<br>";
                                    $resultado=ejecutarConsulta($sql_temp, $conexion);			
                            }
                        }
                        //Se Verifica que el proponente nuevo no se encuentre en la tabla de usuario_miembro_usb
                        if (!existe_en_bd(replace_form($_POST[prop_usbid_nuevo]),'usuario_miembro_usb','usbid_usuario')){
                            if ($_POST[prop_dependencia]<>""){
                                    $sql_temp="INSERT INTO usuario_miembro_usb (usbid_usuario, dependencia) VALUES (".
                                    "trim('".replace_form($_POST[prop_usbid_nuevo])."'),". //USBID_USUARIO
                                    "trim('".replace_form($_POST[prop_dependencia])."')". //DEPENDENCIA
                                    ")";
                                    if ($modo_depuracion) echo "$sql_temp<br>";
                                    $resultado=ejecutarConsulta($sql_temp, $conexion);
                            }
                            ...
                            $sql_temp="INSERT INTO proponente VALUES (";
                            $sql_temp.="trim('".replace_form($_POST[prop_usbid_nuevo])."'),'$id_proy')";
                            if ($modo_depuracion) echo "$sql_temp<br>";
                            $resultado=ejecutarConsulta($sql_temp, $conexion);	
                    }
            }
    ...
    if( empty($_POST[tutor1_usbid]) ){
        ...
        if (!empty($_POST[tutor1_usbid_nuevo])){
            ...
            if( empty($_POST[tutor1_usbid]) && ($Comparaciones_Con_tutor1)){
                ...
                if (existe_en_bd(replace_form($_POST[tutor1_usbid_nuevo]),'tutor_proy','usbid_miembro')){

                    $usbid_tutor=replace_form($_POST[tutor1_usbid_nuevo]);
                    
                    global $_WARNING;
                    $_WARNING[] = 'El tutor "'.replace_form($_POST[tutor1_nombre]). " ".replace_form($_POST[tutor1_apellido]).'" ya se encontraba registrado
                                con el correo "'.replace_form($_POST[tutor1_usbid_nuevo]).'@usb.ve" <br/> De todas formas, su Proyecto se ha
                                agregado satisfactoriamente.';

                    } else {
                    //Se Verifica que el tutor1 nuevo no se encuentre en la tabla de usuario
                    if (!existe_en_bd(replace_form($_POST[tutor1_usbid_nuevo]),'usuario','usbid')){
                        $sql_temp="INSERT INTO usuario (usbid, nombre, apellido, password, ci) VALUES (".
                        "trim('".replace_form($_POST[tutor1_usbid_nuevo])."'), ".//usbid
                        "trim('".replace_form($_POST[tutor1_nombre])."'), ".//nombre
                        "trim('".replace_form($_POST[tutor1_apellido])."'), ".//apellido	
                        "'1234', ".//password		
                        "trim('".replace_form($_POST[tutor1_ci])."' )".//ci
                        ")";
                        if ($modo_depuracion) echo "$sql_temp<br>";	
                        $resultado=ejecutarConsulta($sql_temp, $conexion);
                    }
                    //Se Verifica que el tutor1 nuevo no se encuentre en la tabla de usuario
                    if (!existe_en_bd(replace_form($_POST[tutor1_usbid_nuevo]),'usuario_miembro_usb','usbid_usuario')){
                        $sql_temp="INSERT INTO usuario_miembro_usb VALUES (".
                        "trim('".replace_form($_POST[tutor1_usbid_nuevo])."'), ".//usbid_usuario
                        "trim('".replace_form($_POST[tutor1_dependencia])."'), ".//dependencia	
                        "'', ".//email secundario	
                        "trim('".replace_form($_POST[tutor1_tlf])."'), ".//tlf	
                        "'' ".//celular
                        ")";
                        if ($modo_depuracion) echo "$sql_temp<br>";
                        $resultado=ejecutarConsulta($sql_temp, $conexion);	
            ...
            $usbid_tutor=replace_form($_POST[tutor1_usbid]);
    }
    ...
    if ( empty($_POST[tutor2_usbid])){
        if (!empty($_POST[tutor2_usbid_nuevo])){
            if( empty($_POST[tutor2_usbid]) && $Comparaciones_Con_tutor2 ){
                ...
                //Se Verifica que el tutor nuevo no se encuentre en la tabla de proponente
                if (existe_en_bd(replace_form($_POST[tutor2_usbid_nuevo]),'tutor_proy','usbid_miembro')){

                    $usbid_tutor=replace_form($_POST[tutor2_usbid_nuevo]);
                    global $_WARNING;
                    $_WARNING[] = 'El tutor "'.replace_form($_POST[tutor2_nombre]). " ".replace_form($_POST[tutor2_apellido]).'" ya se encontraba registrado
                                con el correo "'.replace_form($_POST[tutor2_usbid_nuevo]).'@usb.ve" <br/> De todas formas, su Proyecto se ha
                                agregado satisfactoriamente.';
                    ...
                    if (!existe_en_bd($_POST[tutor2_usbid_nuevo],'usuario','usbid')){
                        $sql_temp="INSERT INTO usuario (usbid, nombre, apellido, password, ci) VALUES (".
                        "trim('".replace_form($_POST[tutor2_usbid_nuevo])."'), ".//usbid
                        "trim('".replace_form($_POST[tutor2_nombre])."'), ".//nombre
                        "trim('".replace_form($_POST[tutor2_apellido])."'), ".//apellido
                        "'1234', ".//password
                        "trim('".replace_form($_POST[tutor2_ci])."') ".//ci
                        ")";
                    }
                    //Se Verifica que el tutor2 nuevo no se encuentre en la tabla de usuario
                    if (!existe_en_bd(replace_form($_POST[tutor2_usbid_nuevo]),'usuario_miembro_usb','usbid_usuario')){
                        if ($modo_depuracion) echo "$sql_temp<br>";
                        $resultado=ejecutarConsulta($sql_temp, $conexion);

                        $sql_temp="INSERT INTO usuario_miembro_usb VALUES (".
                        "trim('".replace_form($_POST[tutor2_usbid_nuevo])."'), ".//usbid_usuario
                        "trim('".replace_form($_POST[tutor2_dependencia])."'), ".//dependencia
                        "'', ".//email secundario
                        "trim('".replace_form($_POST[tutor2_tlf])."'), ".//tlf
                        "trim('".replace_form($_POST[tutor2_ci])."')".//ci
                        ")";
                        if ($modo_depuracion) echo "$sql_temp<br>";
                        $resultado=ejecutarConsulta($sql_temp, $conexion);
                    }
                        $usbid_tutor2=replace_form($_POST[tutor2_usbid_nuevo]);
        ...
        $usbid_tutor2=replace_form($_POST[tutor2_usbid]);
    }
    if ( !empty($usbid_tutor2) ){
            $sql_temp="INSERT INTO tutor_proy VALUES (".
            "'".replace_form($usbid_tutor2)."', ".//usbid_usuario
            "'$id_proy' ".//id_proyecto	
            ")";
            if ($modo_depuracion) echo "$sql_temp<br>";
            $resultado=ejecutarConsulta($sql_temp, $conexion);	
...
function guardar_tutor3($id_proy,$Comparaciones_Con_tutor3){    
        ...
        if (!empty($_POST[tutor3_usbid_nuevo])){
            if( empty($_POST[tutor3_usbid]) && $Comparaciones_Con_tutor3 ){
                    if($_POST[tutor3_usbid_nuevo]<>""){
                        ...
                        //Se Verifica que el tutor nuevo no se encuentre en la tabla de proponente
                        if (existe_en_bd(replace_form($_POST[tutor3_usbid_nuevo]),'tutor_proy','usbid_miembro')){

                        $usbid_tutor=replace_form($_POST[tutor3_usbid_nuevo]);
                        global $_WARNING;
                        $_WARNING[] = 'El tutor "'.replace_form($_POST[tutor3_nombre]). " ".replace_form($_POST[tutor3_apellido]).'" ya se encontraba registrado
                                con el correo "'.replace_form($_POST[tutor3_usbid_nuevo]).'@usb.ve" <br/> De todas formas, su Proyecto se ha
                                agregado satisfactoriamente.';

                } else {

                    //Se Verifica que el tutor3 nuevo no se encuentre en la tabla de usuario
                    if (!existe_en_bd(replace_form($_POST[tutor3_usbid_nuevo]),'usuario','usbid')){
                        $sql_temp="INSERT INTO usuario (usbid, nombre, apellido, password, ci) VALUES (".
                        "trim('".replace_form($_POST[tutor3_usbid_nuevo])."'), ".//usbid
                        "trim('".replace_form($_POST[tutor3_nombre])."'), ".//nombre
                        "trim('".replace_form($_POST[tutor3_apellido])."'), ".//apellido
                        "'1234', ".//password
                        "trim('".replace_form($_POST[tutor3_ci])."') ".//ci
                        ")";
                        if ($modo_depuracion) echo "$sql_temp<br>";
                        $resultado=ejecutarConsulta($sql_temp, $conexion);
                    }
                    //Se Verifica que el tutor3 nuevo no se encuentre en la tabla de usuario
                    if (!existe_en_bd(replace_form($_POST[tutor3_usbid_nuevo]),'usuario_miembro_usb','usbid_usuario')){
                        $sql_temp="INSERT INTO usuario_miembro_usb VALUES (".
                        "trim('".replace_form($_POST[tutor3_usbid_nuevo])."'), ".//usbid_usuario
                        "trim('".replace_form($_POST[tutor3_dependencia])."'), ".//dependencia
                        "'', ".//email secundario
                        "trim('".replace_form($_POST[tutor3_tlf])."'), ".//tlf
                        "trim('".replace_form($_POST[tutor3_ci])."')".//ci
                        ")";
                        if ($modo_depuracion) echo "$sql_temp<br>";
                        $resultado=ejecutarConsulta($sql_temp, $conexion);
                    }
                        $usbid_tutor3=replace_form($_POST[tutor3_usbid_nuevo]);

                    }

                }
            } else {
                    $usbid_tutor3=replace_form($_POST[tutor3_usbid]);
            }
        }
    } else {
                $usbid_tutor3=replace_form($_POST[tutor3_usbid]);
    ...
    if ( !empty($usbid_tutor3) ){
            $sql_temp="INSERT INTO tutor_proy VALUES (".
            "'".replace_form($usbid_tutor3)."', ".//usbid_usuario
            "'$id_proy' ".//id_proyecto	
            ")";
            if ($modo_depuracion) echo "$sql_temp<br>";
            $resultado=ejecutarConsulta($sql_temp, $conexion);	
...
if( isset($accion) AND $accion == 'agregar_proyecto')
{
	...
	if($cant_fem<1){ 
		$_ERRORES[] ="Debe especificar la cantidad de mujeres que beneficiar&aacute; el proyecto.";
            ...
            $_ERRORES[] ="Error de formato en la cantidad de mujeres que beneficiar&aacute; el proyecto.";	
	if($cant_masc<1){ 
		$_ERRORES[] ="Debe especificar la cantidad de hombres que beneficiar&aacute; el proyecto.";
	} if (!is_numeric($cant_masc))
            $_ERRORES[] ="Error de formato en la cantidad de  hombres que beneficiar&aacute; el proyecto.";
	if($cant_disc<1){ 
		$_ERRORES[] ="Debe especificar la cantidad de personas con discapacidad que beneficiar&aacute; el proyecto.";
	} if (!is_numeric($cant_disc))
            $_ERRORES[] ="Error de formato en la cantidad de personas con discapacidad que beneficiar&aacute; el proyecto.";
        if($min_edad==""){ 
