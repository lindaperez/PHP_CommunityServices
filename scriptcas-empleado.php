...
$sql = "SELECT * FROM usuario WHERE usbid='coord-psc'";
...
// 			   $tipo=explode("/",$tipo_per);
			   $_SESSION[tipo]="empleados";
                           if ($_SESSION[tipo]=="empleados"){
                               $sql2 = "SELECT sede FROM rol_sistema WHERE usbid='$_SESSION[USBID]'";
                               $resultado2=ejecutarConsulta($sql2, $conexion);
                               $fila2=  obtenerResultados($resultado2);
                               $_SESSION[sede]=$fila2[sede];
                           } else if ($_SESSION[tipo]!="empleados") $_SESSION[sede]='';
// 			   }
//                else
//                {
               //	"Error en el bind\n";
